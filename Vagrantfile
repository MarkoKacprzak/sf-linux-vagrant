...
Vagrant.configure(2) do |config|
  config.vm.box = "azureservicefabric/linuxonebox_0.4.0.0"
  config.vm.box_url = "https://servicefabricsdkpreview.blob.core.windows.net/linux/sflinuxonebox_0.4.0.0.box"
